...
RUN set -ex \
 ...
 && MAVEN_OPTS="-Dhttps.proxyHost=10.158.100.1 -Dhttps.proxyPort=8080 -Xmx2g -XX:MaxPermSize=1024m" /tmp/apache-maven-3.5.0/bin/mvn --batch-mode package -DskipTests -Pscala-2.11 -Pbuild-distr \
